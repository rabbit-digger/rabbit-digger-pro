...
use rd_interface::{
    async_trait, config::from_value, context::common_field::SourceAddress, util::connect_tcp,
    Context, IServer, IntoAddress, Net, Registry, Result,
};
use serde_derive::Deserialize;

#[derive(Debug, Deserialize)]
struct RedirServerConfig {
    bind: String,
}
...
impl RedirServer {
    fn new(cfg: RedirServerConfig, net: Net) -> Self {
        RedirServer { cfg, net }
    }
